...
Public Class BDHelper
    ...
    Private Sub New()
        '/////////////////////////////////////// CONNECTION STRING: ////////////////////////////////////////
        '//////// Comentar o Descomentar el String de Conexion segun desde donde se este accediendo. ///////
        '/// Si es una conexion que no es de las listadas, agregarla en un apartado aparte tal como esta ///
        '///////////////////////////////////////// descripto aca. //////////////////////////////////////////

        'PC - LABSIS
        string_conexion = "Data Source=maquis;Initial Catalog=DB_CompuMax;Persist Security Info=True;User ID=avisuales1;Password=avisuales1"
        'PC - Facundo F
        'string_conexion = "Data Source=localhost\SQLEXPRESS;Initial Catalog=DB_CompuMax;Persist Security Info=True;User ID=sa;Password=Facu1123581321"
        'PC - Maxi P
        'string_conexion = "Data Source=(local);Initial Catalog=DB_CompuMax;Integrated Security=True"
        'PC - Maxi G
        'string_conexion = "Data Source=MAXX-PC;Initial Catalog=DB_CompuMax;Integrated Security=True"
    End Sub
    ...
    Public Function EjecutarTransaccionSQL(ByVal strSql As String) As Integer
        ' Se utiliza para sentencias SQL del tipo “Insert/Update/Delete”
        Dim conexion As New SqlConnection
        Dim cmd As New SqlCommand
    ...
    Public Function EjecutarProcedimientoAlmacenado(ByVal strSql As String) As DataTable
        ' Se utiliza para sentencias SQL del tipo “Insert/Update/Delete”
        Dim conexion As New SqlConnection
        Dim cmd As New SqlCommand
        Dim tabla As New DataTable
